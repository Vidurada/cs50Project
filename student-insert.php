            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="header">
                                ...
                                <p class="category">Education Level</p>
                            </div>
                            <div class="content">
                                ...
                                <div class="footer">
                                    <div class="legend">
                                        <i class="fa fa-circle text-info"></i> Undergraduate
                                        <i class="fa fa-circle text-danger"></i> Postgraduate
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Student GPA Chart</h4>
                            ...
                            <div class="content">
                                ...
                                <div class="footer">
                                    <div class="legend">
                                        <i class="fa fa-circle text-info"></i> Undergraduate
                                        <i class="fa fa-circle text-danger"></i> Postgraduate
                                        <!--<i class="fa fa-circle text-warning"></i> Click Second Time-->s
                                    </div>
                                    <hr>
                                    <div class="stats">
                                        <i class="fa fa-history"></i> Upto Final Semester
                                    </div>
                                </div>
                            </div>
                        </div>
